...
public class ResourceManager : MonoBehaviour
{
    ...
    public void AddPower(int amount) { power += amount; UpdateUI(); }
    public void AddBudget(int amount) { budget += amount; UpdateUI(); }
    public void AddTime(int amount) { time += amount; UpdateUI(); }
}